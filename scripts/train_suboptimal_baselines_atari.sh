python baselines/train_ppo_base_atari.py --environment "ALE/Breakout-v5" --seed 0 --max_steps 1000000 --output_dir "baselines/suboptimal_pretrained_policies" --env_reward_threshold 200 --tags "suboptimal" "ppo" "atari" "breakout"
echo "Breakout done" 
